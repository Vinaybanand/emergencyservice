...
<?php
	...
	$sql = "SELECT * FROM examseat WHERE tid='".$tid."' AND cid='104';";	
	$res = mysqli_query($conn,$sql);
	$arr=mysqli_fetch_assoc($res);
...
<body>
	<div class="shape" style="position:absolute; left: 680px; top: 20px;">104</div>
	<br/>
	<br/>
	...
	<a href="show303.php" class="previous" style="position:absolute; left: 100px; top: 690px;">Previous</a>
