...
<?php
	...
	$sql = "SELECT * FROM examseat WHERE tid='".$tid."' AND cid='102';";	
	$res = mysqli_query($conn,$sql);
	$arr=mysqli_fetch_assoc($res);
...
<body>
	<div class="shape" style="position:absolute; left: 680px; top: 20px;">102</div>
	<br/>
	<br/>
	...
	<a href="show301.php" class="previous" style="position:absolute; left: 100px; top: 690px;">Previous</a>
	<a href="show303.php" class="previous" style="position:absolute; left: 1400px; top: 690px;">Next</a>
</body>
</html>
