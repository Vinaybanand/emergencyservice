...
<?php
	...
	$sql = "SELECT * FROM examseat WHERE tid='".$tid."' AND cid='103';";	
	$res = mysqli_query($conn,$sql);
	$arr=mysqli_fetch_assoc($res);
...
<body>
	<div class="shape" style="position:absolute; left: 680px; top: 20px;">103</div>
	<br/>
	<br/>
	...
	<a href="show302.php" class="previous" style="position:absolute; left: 100px; top: 690px;">Previous</a>
	<a href="show304.php" class="previous" style="position:absolute; left: 1400px; top: 690px;">Next</a>
</body>
</html>
